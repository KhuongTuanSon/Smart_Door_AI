...
## 📂 Cấu trúc mã nguồn
* `imageprocessing.py`: File Python xử lý hình ảnh từ camera, nhận diện cử chỉ và gửi dữ liệu lên Firebase / Serial.
* `Arduino.ino`: Code Arduino nạp vào mạch để đọc dữ liệu và điều khiển Servo.
